...
export default function ServiceItem({ service }) {
  return (
    <div className="bg-[#412f7b26] h-max rounded-lg px-6 py-8 flex flex-col gap-x-0 group cursor-pointer items-stretch hover:bg-[#5941a926] transtition-all duration-300">
