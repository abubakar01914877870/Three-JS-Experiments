    ...
    <div className="items-center justify-center max-w-screen-xl gap-6 px-4 overflow-hidden md:flex-row bg-hero">
      {heading && (
        <div className="flex flex-col w-full mb-4 text-center">
          <h2 className="h2 xl:mt-8">{heading}</h2>
        </div>
      )}

      <div className="flex flex-col items-center justify-center max-w-screen-xl gap-6 px-4 overflow-hidden md:flex-row bg-hero">
        <div
        ...
        <div
          className={`text-center flex md:w-[50vw] lg:w-[30vw] flex-col md:text-left mb-4 md:mb-0 ${
